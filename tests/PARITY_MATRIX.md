...
| Expanded TV menu | Left from the first Home action opens seven Blits focus rows; Down focuses Discover. Right/Back restore the remembered Home action. Profile activates profile selection; Home and Discover route to content. Tizen/Vizio/webOS browser captures were byte-equal. Search, Live TV, My List and Settings remain unimplemented in the staged renderer. | `TvMenu` vs React: 1,625,803 changed pixels (78.4049%), MAE 3.7609, RMSE 12.2046, SSIM 0.930841. The Home background contributes to the full-frame difference; exact pixel parity remains open. | Browser fixture only; physical remote behavior unverified. |
| Discover / Genre filter | The staged Blits route loads normalized catalogs and cards from the shared API/core. Browser D-pad fixtures exercised a 4-column focus window, selected-card detail/Back restoration, Genre choice request, catalog/type switching and return to Home. The modal keeps its own focus and Back. Tizen/Vizio/webOS browser captures were byte-equal for both states. Required text entry, horizontally overflowing chips, long filter lists and physical navigation remain pending. | `TvDiscover` vs React: 797,513 changed pixels (38.4603%), MAE 8.0147, RMSE 28.2300, SSIM 0.864570. `TvDiscoverFilter`: 1,178,903 changed (56.8530%), MAE 3.3850, RMSE 14.9249, SSIM 0.940365. Both open deviations. | Browser fixtures only; no physical Tizen/Vizio/webOS run of Blits. |

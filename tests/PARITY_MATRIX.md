...
| Expanded TV menu | Left from the first Home action opens seven Blits focus rows; Down focuses Discover. Right/Back restore the remembered Home action. Profile activates profile selection; Home returns to content. Tizen/Vizio/webOS browser captures were byte-equal. Search, Discover, Live TV, My List and Settings remain unimplemented in the staged renderer. | `TvMenu` vs React: 1,625,803 changed pixels (78.4049%), MAE 3.7609, RMSE 12.2046, SSIM 0.930841. The Home background contributes to the full-frame difference; exact pixel parity remains open. | Browser fixture only; physical remote behavior unverified. |

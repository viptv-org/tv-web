...
| Home data / first frame | Shared API/Rust hero and queue projections feed a staged Lightning Home capture; profile queue request observed. Actions, shelf-card and rail focus/routes remain pending. | 1,404,917 pixels changed (67.7526%), MAE 8.7538, RMSE 25.8279, SSIM 0.863854 against current React `TvHome`. Open deviation. | Browser fixture only; no launcher or device qualification. |

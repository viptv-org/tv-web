...
import { Html5FallbackAdapter } from '../../src/player/html5-fallback';
import { IDLE_SNAPSHOT, type PlayerListener, type PlayerSnapshot, type OpenPlayerRequest } from '../../src/player/types';
...
vi.mock('../../src/player/mediabunny', () => ({ MediabunnyAdapter: class {

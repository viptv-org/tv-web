...
export const LiveScreen = Blits.Component("LiveScreen", {
  ...
  props: [
    "homeProfileAvatar", "railSearch", "railHomeUnselected", "railDiscover", "railLiveSelected",
    "railList", "railSettings", "surface", "background", "primary", "body", "keyBorder",
    "hero", "filters", "channels", "programs", "timeline", "nowX", "nowLabel", "status",
    "liveLabel", "previewLabel", "okLabel", "watchLabel", "optionsIcon", "detailsLabel",
    "channelIcon", "channelsLabel", "timeIcon", "timeLabel",
  ] as unknown as {
    ...
    nowX: number; nowLabel: string; status: string; liveLabel: string; previewLabel: string;
    okLabel: string; watchLabel: string; optionsIcon: string; detailsLabel: string;
    channelIcon: string; channelsLabel: string; timeIcon: string; timeLabel: string;
  },
  template: `
    <Element>
      ...
      <Element x="40" y="418" w="64" h="64" rounded="32" color="$surface" />
      <Element x="60" y="438" w="24" h="24" :src="$railLiveSelected" />
      ...
      <Text x="204" y="110" :content="$liveLabel" font="Onest700" size="20" color="$white" :show="$hero.channel !== null" />
      <Text x="274" y="108" :content="$hero.label" font="Onest" size="22" color="$secondary" />
      <Text x="192" y="157" maxwidth="1100" maxlines="1" :content="$hero.title" font="Bricolage700" size="52" color="$primary" />
      ...
      <Text x="1344" y="231" maxwidth="480" align="center" :content="$previewLabel" font="Onest" size="20" color="$tertiary" />
      ...
      <Element x="1216" y="1008" w="44" h="31" rounded="8" color="$keyBorder" />
      <Text x="1226" y="1013" :content="$okLabel" font="Onest700" size="16" color="$primary" />
      <Text x="1275" y="1012" :content="$watchLabel" font="Onest" size="20" color="$body" />
      <Element x="1373" y="1008" w="40" h="31" rounded="8" color="$keyBorder" />
      <Text x="1384" y="1012" :content="$optionsIcon" font="Onest" size="19" color="$primary" />
      <Text x="1424" y="1012" :content="$detailsLabel" font="Onest" size="20" color="$body" />
      <Element x="1523" y="1008" w="58" h="31" rounded="8" color="$keyBorder" />
      <Text x="1535" y="1013" :content="$channelIcon" font="Onest700" size="16" color="$primary" />
      <Text x="1594" y="1012" :content="$channelsLabel" font="Onest" size="20" color="$body" />
      <Element x="1717" y="1008" w="54" h="31" rounded="8" color="$keyBorder" />
      <Text x="1728" y="1013" :content="$timeIcon" font="Onest700" size="16" color="$primary" />
      <Text x="1784" y="1012" :content="$timeLabel" font="Onest" size="20" color="$body" />
    </Element>
  `,
  state() {
    return {

...
| [web](https://github.com/viptv-org/web) | React account/admin web application and future React playback UI | [SPEC.md](https://github.com/viptv-org/web/blob/main/SPEC.md) |
